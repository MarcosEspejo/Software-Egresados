...
<div class="bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto">
    ...
    <div class="p-6">
        <form action="{{ route('egresados.update', $egresado->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="documento" value="{{ $egresado->documento }}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100" readonly disabled>
                <!-- Campo oculto para mantener el valor del documento -->
